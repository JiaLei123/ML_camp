...
def parse_data_fastText(data_path, column_name="article", train_rate=0.8):
    """
    ...
    topN, _ = get_high_low_freq_words(data_path, top=100)
    ...
    if train_rate < 1:
        ...
        test_data.to_csv(os.path.join(base_path, "dev_data_" + column_name + "_fastTest.tsv"), sep='\t')
    else:
